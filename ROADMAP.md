...
- [ ] Scaffold `app/templates/cv_template.docx` — placeholder styling,
      fields bound 1:1 to the `TailoredCV` contract
- [ ] `docxtpl` render to a `secrets.token_urlsafe(32)`-named file in `/tmp`
- [ ] Test: docxtpl render regression against the real template file
